 ...
 *
 * <p>Textures returned by this class are owned by the underlying {@link com.badlogic.gdx.assets.AssetManager} and must not be
...
public class AssetManager {
	...
	private final com.badlogic.gdx.assets.AssetManager assetManager = new com.badlogic.gdx.assets.AssetManager();
	...
	/**
	 * Normalizes a wall texture reference from level JSON into a full internal asset path.
	 *
	 * @param ref the raw texture reference from JSON (may be {@code null}, blank, a filename, or a full path)
	 * @return the normalized internal asset path
	 */
	 ...
	 *
	 * @return list of discovered texture paths
	 */
	...
	public void load() {
		...
		Gdx.app.log("AssetManager", "Auto-loaded " + paths.size() + " textures from assets.txt");
	}

	/**
	 * Returns the list of texture paths that were auto-discovered and loaded.
	 *
	 * @return unmodifiable list of loaded texture paths
	 */
	 ...
	 *
	 * @return the arc texture, or {@code null} if not available
	 */
	...
	/**
	 * Returns (and caches) a sprite set for the given character id.
	 *
	 * <p>The {@code characterId} corresponds to the folder name under {@code textures/character/}.
	 * Textures are auto-discovered by naming convention — see {@link CharacterSpriteSet} for details.</p>
	 *
	 * @param characterId folder name under {@code textures/character/}
	 * @return the sprite set for that character type (never {@code null})
	 * @throws IllegalArgumentException if no matching textures were found
	 */
	 ...
	 * </ul>
	 *
	 * @param jsonTextureRef texture reference string from level JSON
	 * @return the resolved wall texture
	 */
	...
	/**
	 * Disposes the underlying {@link com.badlogic.gdx.assets.AssetManager} and all assets loaded through it.
	 */
	public void dispose() {
