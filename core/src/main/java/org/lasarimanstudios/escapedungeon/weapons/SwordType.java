...
public enum SwordType {
	...
	FAT(GameAssets.TEX_WEAPON_SWORD_FAT, 30f, 0.60f, 2.5f),
	RAINBOW(GameAssets.TEX_WEAPON_SWORD_RAINBOW, 20f, 0.45f, 2.0f),

	DEV(GameAssets.TEX_WEAPON_SWORD_DEV, Float.MAX_VALUE, 0.35f, 20f) {
		@Override
	 ...
	 * @param walls   reference to the wall list (for line-of-sight checks)
